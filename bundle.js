...
eval("__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {\n__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _pokemon_requests__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pokemon-requests */ \"./src/pokemon-requests.js\");\n\r\n\r\n\r\nconst cardContainer = document.querySelector('#pokeGallery');\r\nconst loadMore = document.querySelector('#loadMore');\r\n\r\nlet pokemons;\r\nlet offset = 20;\r\n// let pokemons = await pokemonGetter.requestAnotherRangeOfPokemon({\r\n//   limit: 20,\r\n//   offset: 0\r\n// })\r\n\r\nloadMore.addEventListener('click', async (e) => {\r\n  let nextPage = await loadTwentyPokemon(offset)\r\n  paginate(nextPage)\r\n  offset = offset + 20;\r\n\r\n})\r\n\r\n\r\nconst loadTwentyPokemon = async (offset) => {\r\n  let pokemons = await _pokemon_requests__WEBPACK_IMPORTED_MODULE_1__[\"default\"].requestAnotherRangeOfPokemon({\r\n    limit: 20,\r\n    offset: offset\r\n  });\r\n  return pokemons;\r\n}\r\n\r\n\r\n\r\nconst paginate = (nextPage) => {\r\n  nextPage.forEach(pokemon => {\r\n    const pokeImg = pokemon.sprites.other['official-artwork']['front_default']\r\n    const card = Object.assign(\r\n      document.createElement('div'),\r\n      {\r\n        classList: 'poke-card',\r\n      }\r\n    )\r\n\r\n    const nameContainer = Object.assign(\r\n      document.createElement('div'),\r\n      {\r\n        classList: 'card-name-container',\r\n      }\r\n    )\r\n\r\n    const name = Object.assign(\r\n      document.createElement('h3'),\r\n      {\r\n        textContent: pokemon.name,\r\n      }\r\n    )\r\n\r\n    const number = Object.assign(\r\n      document.createElement('h4'),\r\n      {\r\n        textContent: `#${pokemon.id}`,\r\n      }\r\n    )\r\n\r\n    nameContainer.appendChild(name)\r\n    nameContainer.appendChild(number)\r\n    card.appendChild(nameContainer)\r\n\r\n    const imgContainer = Object.assign(\r\n      document.createElement('div'),\r\n      {\r\n        classList: 'img-container',\r\n      }\r\n    )\r\n\r\n    const img = Object.assign(\r\n      document.createElement('img'),\r\n      {\r\n        src: pokeImg,\r\n        alt: pokemon.name\r\n      }\r\n    )\r\n\r\n    imgContainer.appendChild(img)\r\n    card.appendChild(imgContainer)\r\n\r\n    const typeContainer = Object.assign(\r\n      document.createElement('div'),\r\n      {\r\n        classList: 'type-container'\r\n      }\r\n    )\r\n\r\n    const type = Object.assign(\r\n      document.createElement('span'),\r\n      {\r\n        classList: 'type',\r\n        textContent: pokemon.type\r\n      }\r\n    )\r\n\r\n    typeContainer.appendChild(type)\r\n    card.appendChild(typeContainer)\r\n\r\n    cardContainer.appendChild(card);\r\n  })\r\n}\r\n\r\npokemons = await loadTwentyPokemon(0);\r\npaginate(pokemons);\n__webpack_async_result__();\n} catch(e) { __webpack_async_result__(e); } }, 1);\n\n//# sourceURL=webpack://pokedex/./src/index.js?");

/***/ }),

/***/ "./src/pokemon-requests.js":
/*!*********************************!*\
  !*** ./src/pokemon-requests.js ***!
  \*********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((function pokemonGetter() {\r\n  let pokemonArray = []\r\n\r\n  const requestOnePokemon = async (pokemonId) => {\r\n    const url = `https://pokeapi.co/api/v2/pokemon/${pokemonId}`;\r\n    const response = await fetch(url)\r\n    return new Promise((resolve, reject) => {\r\n      if (response) {\r\n        resolve(response.json())\r\n      }\r\n      else {\r\n        let errorMessage = 'Could not get pokemon at ' + url;\r\n        reject(new Error(errorMessage))\r\n      }\r\n    })\r\n  }\r\n\r\n  const getPokemonList = () => {\r\n    return pokemonArray;\r\n  }\r\n\r\n  const addToPokemonArray = (pokemon) => {\r\n    pokemonArray.push(pokemon);\r\n  }\r\n\r\n  const requestAnotherRangeOfPokemon = async (range) => {\r\n    if (range.firstPokemonIndex < 0 || range.lastPokemonIndex < range.firstPokemonIndex) {\r\n      // emit a signal to populate the dom with error (NOT SURE THINK THIS MORE)\r\n      throw new Error('Range is wrong');\r\n    }\r\n    const url =\r\n      `https://pokeapi.co/api/v2/pokemon?limit=${range.limit}&offset=${range.offset}`;\r\n    const request = await fetch(url);\r\n    const response = await request.json();\r\n    const responseArray = response.results\r\n    const urlArray = responseArray.map(obj => fetch(obj.url))\r\n\r\n    const pokemonList = await Promise.all(urlArray);\r\n    const data = Promise.all(pokemonList.map(pokemon => pokemon.json()))\r\n    return data;\r\n  }\r\n\r\n  return {\r\n    requestOnePokemon,\r\n    getPokemonList,\r\n    requestAnotherRangeOfPokemon,\r\n  }\r\n})());\r\n\n\n//# sourceURL=webpack://pokedex/./src/pokemon-requests.js?");
